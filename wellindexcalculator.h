...
class WellDefinition {
        ...
        private:
            ...
            bool GetIntersection( double fDst1, double fDst2, Vector3d P1, Vector3d P2, Vector3d &Hit);
            bool InBox( Vector3d Hit, Vector3d B1, Vector3d B2, const int Axis);
            // returns true if line (L1, L2) intersects with the box (B1, B2)
            // returns intersection point in Hit
            bool CheckLineBox( Vector3d B1, Vector3d B2, Vector3d L1, Vector3d L2, Vector3d &Hit);
   ...
   * \param bb_cells
            ...
            */
            double dir_well_index(double Lx, double dy, double dz, double ky, double kz, double wellbore_radius, double skin_factor);
