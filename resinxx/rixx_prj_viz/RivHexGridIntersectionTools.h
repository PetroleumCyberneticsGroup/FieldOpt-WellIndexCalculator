...
// ---------------------------------------------------------------
// Interface definition used to compute the geometry for planes
// intersecting a grid
...
*/
  ...
  explicit RivIntersectionVertexWeights(
      size_t edgeVx111, size_t edgeVx112, double k11,
  ...
  // ---------------------------------------------------------------
  explicit RivIntersectionVertexWeights(
      size_t edge1Vx1, size_t edge1Vx2, double normDistFromE1V1,
  ...
  explicit RivIntersectionVertexWeights(
      size_t edge1Vx1,
      size_t edge1Vx2,
      double normDistFromE1V1) : m_count(2) {
