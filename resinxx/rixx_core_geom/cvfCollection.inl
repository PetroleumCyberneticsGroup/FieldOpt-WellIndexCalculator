...
Collection<T>::Collection(const std::vector< T >& vector)
    :   m_vector(vector)
{
}
...
Collection<T>& Collection<T>::operator=(const std::vector< T >& vector)
{
  m_vector = vector;
...
{
//  typename std::vector<ref<T> >::const_iterator
  typename std::vector<T>::const_iterator
      it = std::find(m_vector.begin(), m_vector.end(), data);
  if (it != m_vector.end())
  {
...
{
//  typename std::vector<ref<T> >::iterator
