...
//====================================================================
// Templated array designed for high performance and no overhead over
// C arrays.
template <typename T>
class Array : public ValueArray<T> // public Object,
{
 public:
  Array();
  ...
  void copyData(const T* source,
                size_t numElementsToCopy,
                size_t destIndex);

  void copyData(const Array<T>& source,
                size_t numElementsToCopy,
                size_t destIndex,
                size_t sourceIndex);

  template<typename U>
  void copyConvertedData(const Array<U>& source,
                         size_t numElementsToCopy,
                         size_t destIndex,
                         size_t sourceIndex);
...
//  ref<Array<T> > extractElements(const Array<U>& elementIndices) const;
  ...
  template<typename U>
  Array<T> extractElements(const Array<U>& elementIndices) const;
