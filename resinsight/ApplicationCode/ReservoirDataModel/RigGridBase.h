...
//  void                        coarseningBox(size_t coarseningBoxIndex, size_t* i1, size_t* i2, size_t* j1, size_t* j2, size_t* k1, size_t* k2) const;
 ...
 public:
  ...
  virtual bool cellIJKNeighbor(size_t i, size_t j, size_t k,
 ...
 private:
  ...
  ///< Index into the global cell array stored in main-grid where this grids cells starts.
  size_t m_indexToStartOfCells;

  ///< The LGR index of this grid. Starts with 1. Main grid has index 0.
  size_t m_gridIndex;
