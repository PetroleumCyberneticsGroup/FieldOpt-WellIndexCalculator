...
// -----------------------------------------------------------------
bool RigCell::isLongPyramidCell(double maxHeightFactor,
...
cvf::Vec3d
RigCell::faceNormalWithAreaLenght(cvf::StructGridInterface::FaceType face) const {
...
// -----------------------------------------------------------------
int RigCell::firstIntersectionPoint(const cvf::Ray& ray,
...
// -----------------------------------------------------------------
void RigCell::faceIndices(cvf::StructGridInterface::FaceType face,
