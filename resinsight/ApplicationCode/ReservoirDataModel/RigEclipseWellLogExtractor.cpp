...
///
// -----------------------------------------------------------------
void RigEclipseWellLogExtractor::curveData(const RigResultAccessor* resultAccessor,
...
// -----------------------------------------------------------------
std::vector<size_t>
RigEclipseWellLogExtractor::findCloseCells(const cvf::BoundingBox& bb) {
...
// -----------------------------------------------------------------
cvf::Vec3d
RigEclipseWellLogExtractor::calculateLengthInCell(size_t cellIndex,
  ...
  return RigWellPathIntersectionTools::calculateLengthInCell(hexCorners,
                                                             startPoint,
                                                             endPoint);
}
