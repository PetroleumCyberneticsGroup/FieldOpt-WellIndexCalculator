...
#include "../../Fwk/VizFwk/LibCore/cvfArray.h"
#include "../../Fwk/VizFwk/LibCore/cvfMatrix3.h"
#include "../../Fwk/VizFwk/LibCore/cvfArrayWrapperConst.h"
...
class GeometryTools {
 public:
  ...
  static  cvf::Mat3f computePlaneHorizontalRotationMx(const cvf::Vec3f& inPlaneVec0,
  ...
  static double  linePointSquareDist(const cvf::Vec3d& p1,
                                     const cvf::Vec3d& p2,
                                     const cvf::Vec3d& p3);

  static int        intersectLineSegmentTriangle(const cvf::Vec3d p0, const cvf::Vec3d p1,
                                                 const cvf::Vec3d t0, const cvf::Vec3d t1,
                                                 const cvf::Vec3d t2,
                                                 cvf::Vec3d* intersectionPoint,
                                                 bool * isLineDirDotNormalNegative);

  static cvf::Vec3d barycentricCoords(const cvf::Vec3d&  t0, const cvf::Vec3d&  t1,
                                      const cvf::Vec3d&  t2, const cvf::Vec3d&  p);

  static cvf::Vec4d barycentricCoords(const cvf::Vec3d&  v0, const cvf::Vec3d&  v1,
                                      const cvf::Vec3d&  v2, const cvf::Vec3d& v3,
                                      const cvf::Vec3d&  p);
  ...
  static double     getAngle(const cvf::Vec3d& positiveNormalAxis,
                             const cvf::Vec3d& v1, const cvf::Vec3d& v2);
...
class EdgeIntersectStorage
{
 public:
  ...
  bool findIntersection(IndexType e1P1, IndexType e1P2,
                        IndexType e2P1, IndexType e2P2,
  ...
  void addIntersection(IndexType e1P1, IndexType e1P2,
                       IndexType e2P1, IndexType e2P2,
                       IndexType vxIndexIntersectionPoint,
                       GeometryTools::IntersectionStatus intersectionStatus,
                       double fractionAlongEdge1, double fractionAlongEdge2);
 ...
 private:
  ...
  void canonizeAddress(IndexType& e1P1, IndexType& e1P2,
                       IndexType& e2P1, IndexType& e2P2,
  ...
  // leastVxIdxEdge1, largestVxIdxEdge1, leastVxIdxEdge2, largestVxIdxEdge2,
  // { vxIdxIntersection, fractionAlongEdg1, fractionAlonEdge2 }
...
class EarClipTesselator
{
 ...
 protected:
  ...
  bool    isPointInsideTriangle(const cvf::Vec3d& A, const cvf::Vec3d& B,
