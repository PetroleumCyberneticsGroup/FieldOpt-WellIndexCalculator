...
#include "../Application/RiaDefines.h"
...
//==================================================================
/// Class containing the results for the complete number of active
/// cells. Both main grid and LGR's
//==================================================================
...
//  void setTimeStepInfos(size_t scalarResultIndex,
//                        const std::vector<RigEclipseTimeStepInfo>& timeStepInfos);

//  size_t findOrLoadScalarResultForTimeStep(RiaDefines::ResultCatType type,
//                                           const QString& resultName,
//                                           size_t timeStepIndex);

  size_t findOrLoadScalarResult(RiaDefines::ResultCatType type,
                                const QString& resultName);

  ///< Simplified search. Assumes unique names across types.
//  size_t findOrLoadScalarResult(const QString& resultName);

  // Find or create a slot for the results

//  size_t findOrCreateScalarResultIndex(RiaDefines::ResultCatType type,
//                                       const QString& resultName,
//                                       bool needsToBeStored);

  size_t findScalarResultIndex(RiaDefines::ResultCatType type,
...
//  void clearScalarResult(RiaDefines::ResultCatType type,
//                         const QString & resultName);
...
//  void clearAllResults();
  ...
  std::vector<double>& cellScalarResults(size_t scalarResultIndex,
                                         size_t timeStepIndex);

//  bool updateResultName(RiaDefines::ResultCatType resultType,
...
//  void computeMobilePV();
 ...
 private:
  ///< Scalar results on the complete reservoir for
  ///< each Result index (ResultVariable) and timestep
  std::vector< std::vector< std::vector<double> > >  m_cellScalarResults;
