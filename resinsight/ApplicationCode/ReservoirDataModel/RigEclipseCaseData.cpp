...
//  {
//    if (m_wellCellsInGrid[gIdx].isNull() ||
//        m_wellCellsInGrid[gIdx]->size() != grids[gIdx]->cellCount())
//    {
...
//            // If we add test for active cell, thorough testing and verification of the
//            // new behaviour must be adressed
//
//            m_wellCellsInGrid[gridIndex]->set(gridCellIndex, true);
//            m_gridCellToResultWellIndex[gridIndex]->set(gridCellIndex,
//                                                        static_cast<cvf::uint>(wIdx));
//          }
//        }
//      }
//    }
...
//  {
//    cvf::StructGridInterface::FaceType sourceFace =
//        static_cast<cvf::StructGridInterface::FaceType>(faceIdx);
//
//    size_t ni, nj, nk;
...
//RigEclipseCaseData::simulationWellBranches(const QString& simWellName,
